...
import { type BreadcrumbItem, Odontogram, GigiData, OdontogramFormData } from '@/types';
...
export default function EditOdontogram({ odontogram }: Props) {
    ...
    const { data, setData, put, processing } = useForm<OdontogramFormData>({
        pemeriksaan_ekstra_oral: odontogram.pemeriksaan_ekstra_oral || '',
        pemeriksaan_intra_oral: odontogram.pemeriksaan_intra_oral || '',
        ...
        status_d: odontogram.status_d,
        status_m: odontogram.status_m,
        status_f: odontogram.status_f,
        hasil_pemeriksaan_penunjang: odontogram.hasil_pemeriksaan_penunjang || '',
        diagnosa: odontogram.diagnosa || '',
        planning: odontogram.planning || '',
        edukasi: odontogram.edukasi || '',
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        put(`/odontogram/${odontogram.id}`);
    };

    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Edit Odontogram" />
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                            ...
                            <div>
                                ...
                                <p className="font-medium">
                                    {kunjungan && format(new Date(kunjungan.tanggal_kunjungan), 'dd MMMM yyyy', { locale: id })}
                                </p>
                            </div>
                        </div>
                    </CardContent>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        ...
                        <div className="space-y-6">
                            ...
                            <Button type="submit" className="w-full" disabled={processing}>
                                ...
                                {processing ? 'Menyimpan...' : 'Update Odontogram'}
                            </Button>
                        </div>
                    </div>
                </form>
