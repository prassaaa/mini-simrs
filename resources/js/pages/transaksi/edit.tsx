...
import { type BreadcrumbItem, type Kunjungan, type Transaksi } from '@/types';
...
const breadcrumbs = (transaksi: Transaksi): BreadcrumbItem[] => [
    ...
    },
    {
        ...
        href: TransaksiController.edit(transaksi.id).url,
    },
];
...
export default function Edit({ transaksi, kunjungans }: Props) {
    const [details, setDetails] = useState<DetailItem[]>(
        transaksi.details?.map((d) => ({
            nama_tindakan: d.nama_tindakan,
                                ...
                                <div className="grid gap-2">
                                    ...
                                    <div className="grid gap-2">
                                        ...
                                        <Select
                                            ...
                                            defaultValue={transaksi.no_registrasi_kunjungan}
                                            required
                                        >
                                            <SelectTrigger>
